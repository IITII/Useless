...
while getopts "m:he" arg; do #选项后面的冒号表示该选项需要参数
    ...
    e)
        ...
        echo -e "截取长度为30秒的视频："
        echo -e "./ffmpeg.sh -m 10 input.mp4 00:00:10 00:00:30 output.mp4"
        echo -e "截取长度为30秒的视频："
        echo -e "./ffmpeg.sh -m 11 input.mp4 00:00:10 00:00:40 output.mp4"
        echo -e "将视频的播放速度调整为4倍："
        echo -e "./ffmpeg.sh -m 12 input.mp4 0.25 output.mp4"
        ;;
    ?) #当有不认识的选项的时候arg为?
